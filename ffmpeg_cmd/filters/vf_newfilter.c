...
//初始化 设置DrawBoxContext用于画box的颜色，yuv格式
...
//这里是配置 DrawBoxContext的x,y,w,h.thickness这些参数
...
#if CONFIG_NEWFILTER_FILTER

//这里是参数，OFFSET是 DrawBoxContext的字段偏移，把输入的数存到对应的字段
static const AVOption newfilter_options[] = {
...
AVFILTER_DEFINE_CLASS(newfilter);

static const AVFilterPad newfilter_inputs[] = {
    {
        .name           = "default",
...
static const AVFilterPad newfilter_outputs[] = {
    {
        .name = "default",
        .type = AVMEDIA_TYPE_VIDEO,
    },
...
//这里是定义的新的 AVFilter
AVFilter ff_vf_newfilter = {
    .name          = "newfilter",
    .description   = NULL_IF_CONFIG_SMALL("Draw a colored box on the input video."),
    .priv_size     = sizeof(DrawBoxContext),
    .priv_class    = &newfilter_class,
    .init          = init,
    .query_formats = query_formats,
    .inputs        = newfilter_inputs,
    .outputs       = newfilter_outputs,
    .flags         = AVFILTER_FLAG_SUPPORT_TIMELINE_GENERIC,
};
#endif /* CONFIG_NEWFILTER_FILTER */
